    ...
    <div className={styles.container}>
      <main className={styles.main}>
        ...
        <p className={styles.description}>
          ...
          <code className={styles.code}> and then, </code> watch your $ARB rewards grow!
        </p>
        ...
        <div className={styles.grid}>
          <a href="https://arbiscan.io/address/0xaa9d9a8f810463f24825c05f3075c1fc6a430430#internaltx/" className={styles.card}>
            <h2>Arbiscan &rarr;</h2>
            <p>
              View the staking contract on the Arbitrum block explorer
            </p>
          </a>
